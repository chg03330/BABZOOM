...
namespace DoitDoit.Nutrition
{
    ...
    public class CALORIE : nutBase // 칼로리 - 하루 섭취 열량 : 표준체중 x 활동지수 (정도에따라다른데, 여기선 30)
    {
        public CALORIE(Boolean sex, int age)
        {
            NUT_UNIT = "Kcal";
            AVG_INTAKE = UserModel.GetInstance.AvgHeight * 30;
            HOP_INTAKE = UserModel.GetInstance.AvgHeight * 30;
        }
    }//칼로리
